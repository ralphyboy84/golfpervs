    ...
    <div class="col-lg-12 col-xs-12">
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-tree"></i> Rate Course</h3>
        </div>
        <div class="box-body">
            <form class="form-horizontal" role="form" id="addCourseForm">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button id="viewCourseButtonForRating" type="button" class="btn btn-primary">Select Course</button>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10" id='viewCourseInfoForRating'>
